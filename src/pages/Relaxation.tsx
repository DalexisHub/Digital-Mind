...
import { Play, Pause, RotateCcw, Volume2, Heart, Waves } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-3xl font-bold text-slate-800">Centro de Relajación</h1>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Dedica unos minutos a cuidar tu bienestar mental con ejercicios de relajación guiados
          </p>
        </div>
